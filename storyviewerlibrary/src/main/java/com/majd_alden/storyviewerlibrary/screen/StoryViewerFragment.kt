...
import com.majd_alden.storyviewerlibrary.customview.bottom_sheet.BottomSheetItem
import com.majd_alden.storyviewerlibrary.customview.bottom_sheet.ListBottomSheetFragment
            ...
            if (isViewAudienceToMoreMenu) {
                moreMenuDialogBottom?.addBottomItem(
                    ...
                    ListBottomSheetFragment(
                        "Story Viewer",
                        arrayListOf(
                            BottomSheetItem(1, "Ahmed Radwan"),
                            BottomSheetItem(2, "Kareem Ahmed"),
                            BottomSheetItem(3, "Khaled Gamal"),
                            BottomSheetItem(4, "Omar Loai"),
                            BottomSheetItem(5, "Sameer Asi"),
                            BottomSheetItem(6, "Jammal Abu Ramadan"),
                            BottomSheetItem(7, "Khaled Jaber"),
                            BottomSheetItem(8, "Mohammed Dgfdas"),
                        ),
                    ...
                    intent.putExtra("story_id" , counter)
