...
open class OnSwipeTouchListener(context: Activity) : View.OnTouchListener {
    ...
    private fun isAClick(startX: Float, endX: Float, startY: Float, endY: Float): Boolean {
        val isTouchDuration =
            now() - touchDownTime < CLICK_TIME_THRESHOLD  // short time should mean this is a click
        val isTouchLength =
            abs(endX - startX) + abs(endY - startY) < TOUCH_MOVE_THRESHOLD  // short length should mean this is a click
